...
var _f = typeof self == "object" && self && self.Object === Object && self,
  Nf = $r || _f || Function("return this")(),
  Z = Nf;
var Cf = Z.Symbol,
  nt = Cf;
var ai = Object.prototype,
  vf = ai.hasOwnProperty,
  Lf = ai.toString,
  Tr = nt ? nt.toStringTag : void 0;
function bf(e) {
  var t = vf.call(e, Tr),
    r = e[Tr];
  try {
...
function Gf(e) {
  return typeof e == "symbol" || (V(e) && pt(e) == Bf);
}
var ee = Gf;
function Wf(e, t) {
...
var Kf = Array.isArray,
  E = Kf;
var jf = 1 / 0,
  ci = nt ? nt.prototype : void 0,
  ui = ci ? ci.toString : void 0;
function pi(e) {
  if (typeof e == "string") return e;
  if (E(e)) return Pt(e, pi) + "";
  if (ee(e)) return ui ? ui.call(e) : "";
  var t = e + "";
...
var zf = /^\s+/;
function Vf(e) {
  return e && e.slice(0, di(e) + 1).replace(zf, "");
}
var mi = Vf;
function Xf(e) {
  var t = typeof e;
...
function Qf(e) {
  ...
  e = mi(e);
  var r = qf.test(e);
  return r || Zf.test(e) ? Jf(e.slice(2), r ? 2 : 8) : Yf.test(e) ? xi : +e;
}
var gi = Qf;
var Ti = 1 / 0,
  tc = 17976931348623157e292;
function ec(e) {
  if (!e) return e === 0 ? e : 0;
  if (((e = gi(e)), e === Ti || e === -Ti)) {
    var t = e < 0 ? -1 : 1;
...
function lc(e) {
  if (!W(e)) return !1;
  var t = pt(e);
  return t == ic || t == ac || t == oc || t == sc;
}
var ht = lc;
var fc = Z["__core-js_shared__"],
  Hr = fc;
var Ai = (function () {
...
var Xc = Object.prototype,
  Yc = Xc.hasOwnProperty;
function qc(e, t, r) {
  var n = e[t];
  (!(Yc.call(e, t) && Mt(n, r)) || (r === void 0 && !(t in e))) && ke(e, t, r);
}
var ne = qc;
function Zc(e, t, r, n) {
  var o = !r;
  ...
  for (var i = -1, a = t.length; ++i < a; ) {
    ...
    l === void 0 && (l = e[s]), o ? ke(r, s, l) : ne(r, s, l);
  }
  return r;
}
var wt = Zc;
...
function Jc(e, t, r) {
  return (
    (t = Mi(t === void 0 ? e.length - 1 : t, 0)),
    function () {
      for (
        var n = arguments, o = -1, i = Mi(n.length - t, 0), a = Array(i);
        ++o < i;
      ...
      return (s[t] = r(a)), _i(e, this, s);
    }
  );
}
var wi = Jc;
function Qc(e, t) {
  return bi(wi(e, t, St), e + "");
}
var Me = Qc;
...
function nu(e, t, r) {
  if (!W(r)) return !1;
  var n = typeof t;
  return (n == "number" ? J(r) && re(t, r.length) : n == "string" && t in r)
    ? Mt(r[t], e)
    : !1;
}
var oe = nu;
  ...
  return Me(function (t, r) {
    ...
    for (
      i = e.length > 3 && typeof i == "function" ? (o--, i) : void 0,
        a && oe(r[0], r[1], a) && ((i = o < 3 ? void 0 : i), (o = 1)),
        t = Object(t);
      ++n < o;
...
var Di = Object.prototype,
  cu = Di.hasOwnProperty,
  uu = Di.propertyIsEnumerable,
  pu = fo(
    (function () {
      return arguments;
    })()
    ...
    ? fo
    : function (e) {
        return V(e) && cu.call(e, "callee") && !uu.call(e, "callee");
      },
  ie = pu;
function hu() {
  return !1;
...
var Ki = typeof exports == "object" && exports && !exports.nodeType && exports,
  Gi = Ki && typeof module == "object" && module && !module.nodeType && module,
  du = Gi && Gi.exports === Ki,
  Wi = du ? Z.Buffer : void 0,
  mu = Wi ? Wi.isBuffer : void 0,
  xu = mu || Bi,
  zt = xu;
var gu = "[object Arguments]",
  ...
  F = {};
F[Pu] = F[ku] = F[Mu] = F[wu] = F[Fu] = F[Uu] = F[Du] = F[Bu] = F[Gu] = !0;
F[gu] =
  F[Tu] =
  F[Lu] =
  F[Eu] =
...
var $i = typeof exports == "object" && exports && !exports.nodeType && exports,
  Er = $i && typeof module == "object" && module && !module.nodeType && module,
  ju = Er && Er.exports === $i,
  co = ju && $r.process,
  $u = (function () {
    try {
...
function Qu(e) {
  if (!Ft(e)) return zi(e);
  var t = [];
  for (var r in Object(e)) Ju.call(e, r) && r != "constructor" && t.push(r);
  return t;
}
var Jr = Qu;
function tp(e) {
  return J(e) ? qr(e) : Jr(e);
}
var k = tp;
var ep = Object.prototype,
  ...
  np = Fi(function (e, t) {
    ...
    for (var r in t) rp.call(t, r) && ne(e, r, t[r]);
  }),
  tt = np;
function op(e) {
  var t = [];
...
function sp(e) {
  ...
  var t = Ft(e),
    r = [];
  for (var n in e) (n == "constructor" && (t || !ap.call(e, n))) || r.push(n);
  return r;
}
var Xi = sp;
function lp(e) {
  return J(e) ? qr(e, !0) : Xi(e);
}
var ae = lp;
var fp = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,
  cp = /^\w*$/;
function up(e, t) {
  if (E(e)) return !1;
  var r = typeof e;
  return r == "number" || r == "symbol" || r == "boolean" || e == null || ee(e)
    ? !0
    : cp.test(e) || !fp.test(e) || (t != null && e in Object(t));
}
var Ue = up;
var pp = xt(Object, "create"),
  Vt = pp;
function hp() {
...
var Zi = Tp;
var Ep = Object.prototype,
  Ap = Ep.hasOwnProperty;
function Ip(e) {
  var t = this.__data__;
  return Vt ? t[e] !== void 0 : Ap.call(t, e);
}
var Ji = Ip;
...
De.prototype.clear = Yi;
De.prototype.delete = qi;
De.prototype.get = Zi;
De.prototype.has = Ji;
De.prototype.set = Qi;
var uo = De;
...
function Cp(e) {
  ...
  if (r < 0) return !1;
  var n = t.length - 1;
  return r == n ? t.pop() : Np.call(t, r, 1), --this.size, !0;
}
var ea = Cp;
function vp(e) {
  var t = this.__data__,
...
Be.prototype.clear = ta;
Be.prototype.delete = ea;
Be.prototype.get = ra;
Be.prototype.has = na;
Be.prototype.set = oa;
var le = Be;
...
function po(e, t) {
  ...
  return (r.cache = new (po.Cache || Ae)()), r;
}
po.Cache = Ae;
var ua = po;
var Wp = 500;
function Kp(e) {
  var t = ua(e, function (n) {
...
function qp(e, t) {
  t = ue(t, e);
  for (var r = 0, n = t.length; e != null && r < n; ) e = e[Dt(t[r++])];
...
var Ke = Jp;
var ma = nt ? nt.isConcatSpreadable : void 0;
function Qp(e) {
  return E(e) || ie(e) || !!(ma && e && e[ma]);
}
var xa = Qp;
...
var j = th;
var eh = Zr(Object.getPrototypeOf, Object),
  tn = eh;
function rh(e, t, r) {
  var n = -1,
    o = e.length;
...
function nh(e, t, r) {
  var n = e.length;
  return (r = r === void 0 ? n : r), !t && r >= n ? e : $e(e, t, r);
}
var Ta = nh;
var oh = "\\ud800-\\udfff",
  ih = "\\u0300-\\u036f",
...
var Aa = "\\ud800-\\udfff",
  ...
  Sa = Ah + "?",
  Oa = "[" + Th + "]?",
  Rh = "(?:" + Ih + "(?:" + [Ia, Ra, ya].join("|") + ")" + Oa + Sa + ")*",
  yh = Oa + Sa + Rh,
  Sh = "(?:" + [Ia + ho + "?", ho, Ra, ya, Eh].join("|") + ")",
  Oh = RegExp(mo + "(?=" + mo + ")|" + Sh + yh, "g");
function _h(e) {
  return e.match(Oh) || [];
}
var _a = _h;
function Nh(e) {
  return en(e) ? _a(e) : Ea(e);
}
var Na = Nh;
function Ch(e) {
  return function (t) {
    t = Qr(t);
    var r = en(t) ? Na(t) : void 0,
      n = r ? r[0] : t.charAt(0),
      o = r ? Ta(r, 1).join("") : t.slice(1);
    return n[e]() + o;
  };
}
var Ca = Ch;
var vh = Ca("toUpperCase"),
  rn = vh;
function Lh(e, t, r, n) {
  var o = -1,
    i = e == null ? 0 : e.length;
...
var wa = Uh;
function Dh(e, t) {
  return e && wt(t, ae(t), e);
}
var Fa = Dh;
var Ga = typeof exports == "object" && exports && !exports.nodeType && exports,
  Ua = Ga && typeof module == "object" && module && !module.nodeType && module,
  Bh = Ua && Ua.exports === Ga,
  Da = Bh ? Z.Buffer : void 0,
  Ba = Da ? Da.allocUnsafe : void 0;
function Gh(e, t) {
  if (t) return e.slice();
  var r = e.length,
    n = Ba ? Ba(r) : new e.constructor(r);
  return e.copy(n), n;
}
var Wa = Gh;
function Wh(e, t) {
...
var Ha = "[object Map]",
  ...
  sd = Ht(zr),
  Ie = pt;
((ln && Ie(new ln(new ArrayBuffer(1))) != Ya) ||
  (fe && Ie(new fe()) != Ha) ||
  (fn && Ie(fn.resolve()) != za) ||
  (he && Ie(new he()) != Va) ||
  (zr && Ie(new zr()) != Xa)) &&
...
var Ja = md;
var Qa = nt ? nt.prototype : void 0,
  ts = Qa ? Qa.valueOf : void 0;
function xd(e) {
...
var Td = "[object Boolean]",
  ...
  Nd = "[object DataView]",
  Cd = "[object Float32Array]",
  vd = "[object Float64Array]",
  Ld = "[object Int8Array]",
  bd = "[object Int16Array]",
  Pd = "[object Int32Array]",
...
var ns = Ud;
function Dd(e) {
  return typeof e.constructor == "function" && !Ft(e) ? Oi(tn(e)) : {};
}
var os = Dd;
var Bd = "[object Map]";
function Gd(e) {
...
function cn(e, t, r, n, o, i) {
  var a,
    ...
    l = t & zd,
    f = t & Vd;
  if ((r && (a = o ? r(e, n, o, i) : r(e)), a !== void 0)) return a;
  if (!W(e)) return e;
  var c = E(e);
  if (c) {
    if (((a = qa(e)), !s)) return Ni(e, a);
  } else {
    var u = Ct(e),
      p = u == ps || u == Jd;
    if (zt(e)) return Wa(e, s);
    if (u == hs || u == us || (p && !o)) {
      if (((a = l || p ? {} : os(e)), !s))
        return l ? $a(e, Fa(a, e)) : ja(e, wa(a, e));
    } else {
      if (!M[u]) return o ? e : {};
      a = ns(e, u, s);
    }
  ...
  i.set(e, a),
    cs(e)
      ? e.forEach(function (S) {
          a.add(cn(S, t, r, S, e, i));
        })
      : ss(e) &&
        e.forEach(function (S, A) {
          a.set(A, cn(S, t, r, A, e, i));
        });
  var I = f ? (l ? sn : Ar) : l ? ae : k,
    R = c ? void 0 : I(e);
  return (
    Vr(R || e, function (S, A) {
      R && ((A = S), (S = e[A])), ne(a, A, cn(S, t, r, A, e, i));
    }),
    a
  );
}
...
un.prototype.add = un.prototype.push = ms;
un.prototype.has = xs;
var qe = un;
function ym(e, t) {
...
function Nm(e, t, r, n, o, i) {
  ...
  var u = -1,
    p = !0,
    g = r & _m ? new qe() : void 0;
  for (i.set(e, t), i.set(t, e); ++u < s; ) {
    var I = e[u],
      R = t[u];
    if (n) var S = a ? n(R, I, u, t, e, i) : n(I, R, u, e, t, i);
    if (S !== void 0) {
      if (S) continue;
      p = !1;
      break;
    ...
    if (g) {
      if (
        !pn(t, function (A, m) {
          if (!Ze(g, m) && (I === A || o(I, A, r, n, i))) return g.push(m);
        })
      ) {
        p = !1;
        break;
      }
    } else if (!(I === R || o(I, R, r, n, i))) {
      p = !1;
      break;
    }
  }
...
var Lm = 1,
  ...
  Km = "[object DataView]",
  Ts = nt ? nt.prototype : void 0,
  xo = Ts ? Ts.valueOf : void 0;
function jm(e, t, r, n, o, i, a) {
  switch (r) {
    case Km:
    ...
    case Dm:
      var l = n & Lm;
      if ((s || (s = Je), e.size != t.size && !l)) return !1;
      var f = a.get(e);
      if (f) return f == t;
      (n |= bm), a.set(e, t);
      var c = hn(s(e), s(t), n, o, i, a);
      return a.delete(e), c;
    case Gm:
...
function Vm(e, t, r, n, o, i) {
  ...
  for (var u = l; u--; ) {
    var p = s[u];
    if (!(a ? p in t : zm.call(t, p))) return !1;
  }
  var g = i.get(e),
    I = i.get(t);
  if (g && I) return g == t && I == e;
  var R = !0;
  i.set(e, t), i.set(t, e);
  for (var S = a; ++u < l; ) {
    p = s[u];
    var A = e[p],
      m = t[p];
    if (n) var h = a ? n(m, A, p, t, e, i) : n(A, m, p, e, t, i);
    if (!(h === void 0 ? A === m || o(A, m, r, n, i) : h)) {
      R = !1;
      break;
    }
    S || (S = p == "constructor");
...
var Xm = 1,
  ...
  dn = "[object Object]",
  Ym = Object.prototype,
  ys = Ym.hasOwnProperty;
function qm(e, t, r, n, o, i) {
  var a = E(e),
    s = E(t),
    l = a ? Rs : Ct(e),
    f = s ? Rs : Ct(t);
  (l = l == Is ? dn : l), (f = f == Is ? dn : f);
  var c = l == dn,
    u = f == dn,
    p = l == f;
  if (p && zt(e)) {
  ...
  if (p && !c)
    return (
      i || (i = new pe()),
      a || Fe(e) ? hn(e, t, r, n, o, i) : Es(e, t, l, r, n, o, i)
    );
  if (!(r & Xm)) {
    var g = c && ys.call(e, "__wrapped__"),
      I = u && ys.call(t, "__wrapped__");
    if (g || I) {
      var R = g ? e.value() : e,
        S = I ? t.value() : t;
      return i || (i = new pe()), o(R, S, r, n, i);
    }
  }
  return p ? (i || (i = new pe()), As(e, t, r, n, o, i)) : !1;
}
var Ss = qm;
...
function Qm(e, t, r, n) {
  ...
  for (; ++o < i; ) {
    ...
    if (a && s[2]) {
      ...
      var u = new pe();
      if (n) var p = n(f, c, l, e, t, u);
      if (!(p === void 0 ? mn(c, f, Zm | Jm, n, u) : p)) return !1;
    }
  }
  return !0;
}
...
function ix(e, t, r) {
  ...
  return i || ++n != o
    ? i
    : ((o = e == null ? 0 : e.length),
      !!o && we(o) && re(a, o) && (E(e) || ie(e)));
}
var Tn = ix;
function ax(e, t) {
  return e != null && Tn(e, t, vs);
}
var Ls = ax;
var sx = 1,
  lx = 2;
function fx(e, t) {
  return Ue(e) && xn(t)
    ...
    : function (r) {
        var n = da(r, e);
        return n === void 0 && n === t ? Ls(r, e) : mn(t, n, sx | lx);
      };
}
var bs = fx;
function cx(e) {
...
function Ix(e, t) {
  return function (r, n) {
    var o = E(r) ? ws : Gs,
      i = t ? t() : {};
    return o(r, e, Q(n, 2), i);
  };
}
var Ws = Ix;
var Ks = Object.prototype,
  Rx = Ks.hasOwnProperty,
  yx = Me(function (e, t) {
    e = Object(e);
    var r = -1,
      n = t.length,
      o = n > 2 ? t[2] : void 0;
    for (o && oe(t[0], t[1], o) && (n = 1); ++r < n; )
      for (var i = t[r], a = ae(i), s = -1, l = a.length; ++s < l; ) {
        var f = a[s],
          c = e[f];
        (c === void 0 || (Mt(c, Ks[f]) && !Rx.call(e, f))) && (e[f] = i[f]);
      }
    return e;
  }),
  Qe = yx;
...
function Nx(e, t, r, n) {
  ...
  r && (t = Pt(t, Ut(r))),
    n
      ? ((i = En), (a = !1))
      : t.length >= _x && ((i = Ze), (a = !1), (t = new qe(t)));
  t: for (; ++o < s; ) {
    var c = e[o],
      u = r == null ? c : r(c);
    if (((c = n || c !== 0 ? c : 0), a && u === u)) {
      for (var p = f; p--; ) if (t[p] === u) continue t;
      l.push(c);
    } else i(t, u, n) || l.push(c);
  }
  return l;
}
var js = Nx;
var Cx = Me(function (e, t) {
    return go(e) ? js(e, je(t, 1, go, !0)) : [];
  }),
  de = Cx;
function vx(e) {
  var t = e == null ? 0 : e.length;
...
function Lx(e, t, r) {
  ...
  return n
    ? ((t = r || t === void 0 ? 1 : kt(t)), $e(e, t < 0 ? 0 : t, n))
    : [];
}
var X = Lx;
function bx(e, t, r) {
...
function Fx(e, t, r) {
  var n = E(e) ? Hs : zs;
  return r && oe(e, t, r) && (t = void 0), n(e, Q(t, 3));
}
var st = Fx;
function Ux(e, t) {
  var r = [];
...
function Wx(e, t, r) {
  ...
  if (!n) return -1;
  var o = r == null ? 0 : kt(r);
  return o < 0 && (o = Gx(n + o, 0)), Xr(e, Q(t, 3), o);
}
var Xs = Wx;
var Kx = Vs(Xs),
  Wt = Kx;
...
var Vx = Object.prototype,
  ...
  Yx = Ws(function (e, t, r) {
    Xx.call(e, r) ? e[r].push(t) : ke(e, r, [t]);
  }),
  Ir = Yx;
var qx = Object.prototype,
  Zx = qx.hasOwnProperty;
function Jx(e, t) {
  return e != null && Zx.call(e, t);
}
var qs = Jx;
function Qx(e, t) {
  return e != null && Tn(e, t, qs);
}
var T = Qx;
var tg = "[object String]";
function eg(e) {
  return typeof e == "string" || (!E(e) && V(e) && pt(e) == tg);
}
var et = eg;
function rg(e, t) {
...
var Zs = rg;
function ng(e) {
  return e == null ? [] : Zs(e, k(e));
}
var v = ng;
var og = Math.max;
function ig(e, t, r, n) {
  (e = J(e) ? e : v(e)), (r = r && !n ? kt(r) : 0);
  var o = e.length;
  return (
    r < 0 && (r = og(o + r, 0)),
    et(e) ? r <= o && e.indexOf(t, r) > -1 : !!o && Pe(e, t, r) > -1
  );
}
var D = ig;
var ag = Math.max;
function sg(e, t, r) {
  ...
  if (!n) return -1;
  var o = r == null ? 0 : kt(r);
  return o < 0 && (o = ag(n + o, 0)), Pe(e, t, o);
}
var In = sg;
var lg = "[object Map]",
  fg = "[object Set]",
  cg = Object.prototype,
  ug = cg.hasOwnProperty;
function pg(e) {
  if (e == null) return !0;
  if (
    J(e) &&
    ...
    return !e.length;
  var t = Ct(e);
  if (t == lg || t == fg) return !e.size;
  if (Ft(e)) return !Jr(e).length;
  for (var r in e) if (ug.call(e, r)) return !1;
  return !0;
}
var N = pg;
var hg = "[object RegExp]";
function dg(e) {
  return V(e) && pt(e) == hg;
}
var Js = dg;
var Qs = Ot && Ot.isRegExp,
  mg = Qs ? Ut(Qs) : Js,
  _t = mg;
function xg(e) {
  return e === void 0;
...
function Lg(e, t, r) {
  ...
  t: for (; ++n < i; ) {
    var c = e[n],
      u = t ? t(c) : c;
    if (((c = r || c !== 0 ? c : 0), a && u === u)) {
      for (var p = l.length; p--; ) if (l[p] === u) continue t;
      t && l.push(u), s.push(c);
    } else o(l, u, r) || (l !== s && l.push(u), s.push(c));
  }
  return s;
}
var al = Lg;
...
function Pg(e) {
  return kg(e) ? e.LABEL : e.name;
}
function kg(e) {
  return et(e.LABEL) && e.LABEL !== "";
}
var Rt = class {
    get definition() {
...
function er(e) {
  ...
  if (e instanceof P) {
    ...
    return et(e.label) && (r.label = e.label), r;
  } else {
    if (e instanceof w)
    ...
    if (e instanceof q)
      return {
        ...
        idx: e.idx,
        separator: er(new C({ terminalType: e.separator })),
        definition: t(e.definition),
      };
    if (e instanceof H)
      return {
    ...
    if (e instanceof C) {
      let r = {
        ...
        label: Pg(e.terminalType),
        idx: e.idx,
      };
      et(e.label) && (r.terminalLabel = e.label);
      let n = e.terminalType.PATTERN;
      return e.terminalType.PATTERN && (r.pattern = _t(n) ? n.source : n), r;
    } else {
      if (e instanceof mt)
        return {
          type: "Rule",
...
function ye(e, t = []) {
  return e instanceof U || e instanceof L || e instanceof H
    ? !0
    : e instanceof z
    ? Re(e.definition, (n) => ye(n, t))
    : e instanceof P && D(t, e)
    ? !1
    : e instanceof Rt
    ? (e instanceof P && t.push(e), st(e.definition, (n) => ye(n, t)))
    : !1;
}
function Eo(e) {
...
function Et(e) {
  if (e instanceof P) return "SUBRULE";
  if (e instanceof U) return "OPTION";
  if (e instanceof z) return "OR";
  if (e instanceof Y) return "AT_LEAST_ONE";
  if (e instanceof q) return "AT_LEAST_ONE_SEP";
  if (e instanceof H) return "MANY_SEP";
  if (e instanceof L) return "MANY";
  if (e instanceof C) return "CONSUME";
  throw Error("non exhaustive match");
}
var Yt = class {
  walk(t, r = []) {
    x(t.definition, (n, o) => {
      let i = X(t.definition, o + 1);
      if (n instanceof P) this.walkProdRef(n, i, r);
      else if (n instanceof C) this.walkTerminal(n, i, r);
      else if (n instanceof w) this.walkFlat(n, i, r);
      else if (n instanceof U) this.walkOption(n, i, r);
      else if (n instanceof Y) this.walkAtLeastOne(n, i, r);
      else if (n instanceof q) this.walkAtLeastOneSep(n, i, r);
      else if (n instanceof H) this.walkManySep(n, i, r);
      else if (n instanceof L) this.walkMany(n, i, r);
      else if (n instanceof z) this.walkOr(n, i, r);
  ...
  walkAtLeastOne(t, r, n) {
    let o = [new U({ definition: t.definition })].concat(r, n);
    this.walk(t, o);
  }
...
function sl(e, t, r) {
  return [
    new U({
      definition: [new C({ terminalType: e.separator })].concat(e.definition),
    }),
  ].concat(t, r);
}
function Se(e) {
  if (e instanceof P) return Se(e.referencedRule);
  if (e instanceof C) return Fg(e);
  if (To(e)) return Mg(e);
  if (Eo(e)) return wg(e);
  throw Error("non exhaustive match");
}
...
var Ao = class extends Yt {
  ...
  walkTerminal(t, r, n) {}
  walkProdRef(t, r, n) {
    let o = Ug(t.referencedRule, t.idx) + this.topProd.name,
      i = r.concat(n),
      a = new w({ definition: i }),
      s = Se(a);
    this.follows[o] = s;
  }
};
...
var _r = [];
for (let e = y("0"); e <= y("9"); e++) _r.push(e);
var Nr = [y("_")].concat(_r);
for (let e = y("a"); e <= y("z"); e++) Nr.push(e);
for (let e = y("A"); e <= y("Z"); e++) Nr.push(e);
var Ro = [
  y(" "),
  y("\f"),
    ...
    quantifier(t = !1) {
      ...
      switch (this.popChar()) {
        ...
        case "?":
          ...
          break;
        case "{":
          let o = this.integerIncludingZero();
          switch (this.popChar()) {
            case "}":
              r = { atLeast: o, atMost: o };
              break;
            case ",":
              let i;
              this.isDigit()
                ? ((i = this.integerIncludingZero()),
                  (r = { atLeast: o, atMost: i }))
                : (r = { atLeast: o, atMost: 1 / 0 }),
                this.consumeChar("}");
              break;
          }
...
`),
    ...
    characterClassEscape() {
      ...
      return Oe(t) ? { type: "Set", value: t, complement: r } : Or();
    }
    controlEscapeAtom() {
      let t;
      switch (this.popChar()) {
...
`);
      ...
      return Oe(t) ? { type: "Character", value: t } : Or();
    }
    ...
    nulCharacterAtom() {
      return this.consumeChar("0"), { type: "Character", value: y("\0") };
    }
    ...
    identityEscapeAtom() {
      let t = this.popChar();
      return { type: "Character", value: y(t) };
    }
    ...
    characterClass() {
      ...
      for (
        ...
        if (Io(n) && this.isRangeDash()) {
          ...
          } else Sn(n.value, t), t.push(y("-")), Sn(i.value, t);
        } else Sn(n.value, t);
      }
...
`:
    ...
    classEscape() {
      switch ((this.consumeChar("\\"), this.peekChar())) {
        case "b":
          return this.consumeChar("b"), { type: "Character", value: y("\b") };
        case "d":
        case "D":
        case "s":
        case "S":
    ...
    positiveInteger() {
      let t = this.popChar();
      if (Bg.test(t) === !1) throw Error("Expecting a positive integer");
      for (; On.test(this.peekChar(0)); ) t += this.popChar();
      return parseInt(t, 10);
    }
    integerIncludingZero() {
      let t = this.popChar();
      if (On.test(t) === !1) throw Error("Expecting an integer");
      for (; On.test(this.peekChar(0)); ) t += this.popChar();
      return parseInt(t, 10);
    }
    patternCharacter() {
...
`:
    ...
    isDigit() {
      return On.test(this.peekChar(0));
    }
    isClassAtom(t = 0) {
...
`:
    ...
    parseHexDigits(t) {
      ...
      for (let o = 0; o < t; o++) {
        let i = this.popChar();
        if (Dg.test(i) === !1) throw Error("Expecting a HexDecimal digits");
        r += i;
      }
...
function nr(e) {
  let t = e.toString();
  if (_n.hasOwnProperty(t)) return _n[t];
  {
    let r = Gg.pattern(t);
    return (_n[t] = r), r;
  }
...
var ul = "Complement Sets are not supported for first char optimization",
  vr = `Unable to use "first char" lexer optimizations:
`;
function pl(e, t = !1) {
  try {
    let r = nr(e);
    return yo(r.value, {}, r.flags.ignoreCase);
  } catch (r) {
    if (r.message === ul)
      t &&
        Rr(`${vr}	Unable to optimize: < ${e.toString()} >
...
function yo(e, t, r) {
  switch (e.type) {
    case "Disjunction":
      for (let o = 0; o < e.value.length; o++) yo(e.value[o], t, r);
      break;
    case "Alternative":
      let n = e.value;
      for (let o = 0; o < n.length; o++) {
        ...
        switch (a.type) {
          case "Character":
            ...
            break;
          case "Set":
            if (a.complement === !0) throw Error(ul);
            x(a.value, (l) => {
              if (typeof l == "number") Nn(l, t, r);
              else {
                let f = l;
                if (r === !0) for (let c = f.from; c <= f.to; c++) Nn(c, t, r);
                else {
                  for (let c = f.from; c <= f.to && c < or; c++) Nn(c, t, r);
                  if (f.to >= or) {
                    let c = f.from >= or ? f.from : or,
                      u = f.to,
                      p = Kt(c),
                      g = Kt(u);
                    for (let I = p; I <= g; I++) t[I] = I;
                  }
                }
              }
            });
...
function Wg(e, t) {
  let r = String.fromCharCode(e),
    n = r.toUpperCase();
  if (n !== r) {
    let o = Kt(n.charCodeAt(0));
    t[o] = o;
  } else {
    let o = r.toLowerCase();
    if (o !== r) {
      let i = Kt(o.charCodeAt(0));
      t[i] = i;
    }
  }
}
function cl(e, t) {
  return Wt(e.value, (r) => {
    if (typeof r == "number") return D(t, r);
    {
      let n = r;
      return Wt(t, (o) => n.from <= o && o <= n.to) !== void 0;
    }
  });
}
function So(e) {
...
var Oo = class extends ge {
  ...
  visitCharacter(t) {
    D(this.targetCharCodes, t.value) && (this.found = !0);
  }
  visitSet(t) {
    t.complement
      ? cl(t, this.targetCharCodes) === void 0 && (this.found = !0)
      : cl(t, this.targetCharCodes) !== void 0 && (this.found = !0);
  }
};
function Cn(e, t) {
  ...
  } else return Wt(t, (r) => D(e, r.charCodeAt(0))) !== void 0;
}
var _e = "PATTERN",
  ir = "defaultMode",
  vn = "modes",
  No = typeof new RegExp("(?:)").sticky == "boolean";
function ml(e, t) {
  t = Qe(t, {
    useSticky: No,
    debug: !1,
...
`,
    ...
    (o = !1),
      (i = d(n, (m) => {
        ...
        if (_t(h)) {
          ...
          if (ht(h)) return (o = !0), { exec: h };
          if (typeof h == "object") return (o = !0), h;
          if (typeof h == "string") {
            if (h.length === 1) return h;
            {
              let O = h.replace(/[\\^$.*+?()[\]{}|]/g, "\\$&"),
                _ = new RegExp(O);
              return t.useSticky ? dl(_) : hl(_);
            }
          } else throw Error("non exhaustive match");
        }
      }));
  ...
  r("misc mapping", () => {
    (a = d(n, (m) => m.tokenTypeIdx)),
      ...
      (l = d(n, (m) => {
        let h = m.LONGER_ALT;
        if (h) return E(h) ? d(h, (_) => In(n, _)) : [In(n, h)];
      })),
      (f = d(n, (m) => m.PUSH_MODE)),
      (c = d(n, (m) => T(m, "POP_MODE")));
  });
  let u;
  r("Line Terminator Handling", () => {
    let m = yl(t.lineTerminatorCharacters);
    (u = d(n, (h) => !1)),
      t.positionTracking !== "onlyOffset" &&
        (u = d(n, (h) =>
          T(h, "LINE_BREAKS")
            ? !!h.LINE_BREAKS
            : Rl(h, m) === !1 && Cn(m, h.PATTERN)
        ));
  });
  let p, g, I, R;
  r("Misc Mapping #2", () => {
    (p = d(n, Al)),
      ...
      (I = $(
        ...
        (m, h) => {
          let O = h.GROUP;
          return et(O) && O !== it.SKIPPED && (m[O] = []), m;
        },
        {}
      )),
      (R = d(i, (m, h) => ({
        ...
        A = $(
          ...
          (m, h, O) => {
            if (typeof h.PATTERN == "string") {
              let _ = h.PATTERN.charCodeAt(0),
                At = Kt(_);
              _o(m, At, R[O]);
            } else if (E(h.START_CHARS_HINT)) {
              let _;
              x(h.START_CHARS_HINT, (At) => {
                let io = typeof At == "string" ? At.charCodeAt(0) : At,
                  bt = Kt(io);
                _ !== bt && ((_ = bt), _o(m, bt, R[O]));
              });
            } else if (_t(h.PATTERN))
              if (h.PATTERN.unicode)
                (S = !1),
                  t.ensureOptimizations &&
                    tr(`${vr}	Unable to analyze < ${h.PATTERN.toString()} > pattern.
	The regexp unicode flag is not currently supported by the regexp-to-ast library.
	This will disable the lexer's first char optimizations.
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#UNICODE_OPTIMIZE`);
              else {
                let _ = pl(h.PATTERN, t.ensureOptimizations);
                N(_) && (S = !1),
                  x(_, (At) => {
                    _o(m, At, R[O]);
                  });
              ...
              t.ensureOptimizations &&
                tr(`${vr}	TokenType: <${h.name}> is using a custom token pattern without providing <start_chars_hint> parameter.
	This will disable the lexer's first char optimizations.
...
function jg(e) {
  let t = lt(e, (o) => !T(o, _e)),
    r = d(t, (o) => ({
      message:
        "Token Type: ->" + o.name + "<- missing static 'PATTERN' property",
      type: B.MISSING_PATTERN,
      tokenTypes: [o],
    })),
    n = de(e, t);
...
function $g(e) {
  let t = lt(e, (o) => {
      let i = o[_e];
      return !_t(i) && !ht(i) && !T(i, "exec") && !et(i);
    }),
    r = d(t, (o) => ({
      message:
        "Token Type: ->" +
...
function zg(e) {
  ...
  return d(r, (o) => ({
    ...
    type: B.EOI_ANCHOR_FOUND,
    tokenTypes: [o],
  }));
}
function Vg(e) {
  let t = lt(e, (n) => n.PATTERN.test(""));
  return d(t, (n) => ({
    message:
      "Token Type: ->" +
      n.name +
      "<- static 'PATTERN' must not match an empty string",
    type: B.EMPTY_MATCH_PATTERN,
    tokenTypes: [n],
  }));
}
var Xg = /[^\\[][\^]|^\^/;
...
function qg(e) {
  let t = lt(e, (n) => {
    let o = n[_e];
    return o instanceof RegExp && (o.multiline || o.global);
  });
  return d(t, (n) => ({
    message:
      "Token Type: ->" +
    ...
    type: B.UNSUPPORTED_FLAGS_FOUND,
    tokenTypes: [n],
  }));
}
function Zg(e) {
  let t = [],
    r = d(e, (i) =>
      $(
        e,
        (a, s) => (
          i.PATTERN.source === s.PATTERN.source &&
            !D(t, s) &&
            s.PATTERN !== it.NA &&
            (t.push(s), a.push(s)),
          a
  ...
  return d(n, (i) => {
    ...
    return {
      ...
      type: B.DUPLICATE_PATTERNS_FOUND,
      tokenTypes: i,
    };
  });
}
function Jg(e) {
  let t = lt(e, (n) => {
    if (!T(n, "GROUP")) return !1;
    let o = n.GROUP;
    return o !== it.SKIPPED && o !== it.NA && !et(o);
  });
  return d(t, (n) => ({
    message:
      "Token Type: ->" +
    ...
    type: B.INVALID_GROUP_TYPE_FOUND,
    tokenTypes: [n],
  }));
}
function Qg(e, t) {
  let r = lt(e, (o) => o.PUSH_MODE !== void 0 && !D(t, o.PUSH_MODE));
  return d(r, (o) => ({
    message: `Token Type: ->${o.name}<- static 'PUSH_MODE' value cannot refer to a Lexer Mode ->${o.PUSH_MODE}<-which does not exist`,
    type: B.PUSH_MODE_DOES_NOT_EXIST,
    tokenTypes: [o],
  }));
}
function tT(e) {
    ...
    r = $(
      ...
      (n, o, i) => {
        ...
        return (
          a === it.NA ||
            (et(a)
              ? n.push({ str: a, idx: i, tokenType: o })
              : _t(a) &&
                rT(a) &&
                n.push({ str: a.source, idx: i, tokenType: o })),
          n
        );
      },
      []
  ...
  return (
    x(e, (n, o) => {
      x(r, ({ str: i, idx: a, tokenType: s }) => {
        if (o < a && eT(i, n.PATTERN)) {
          let l = `Token: ->${s.name}<- can never be matched.
Because it appears AFTER the Token Type ->${n.name}<-in the lexer's definition.
See https://chevrotain.io/docs/guide/resolving_lexer_errors.html#UNREACHABLE`;
          t.push({
            message: l,
            type: B.UNREACHABLE_PATTERN,
            tokenTypes: [n, s],
          });
        }
      });
...
function eT(e, t) {
  if (_t(t)) {
    ...
    if (ht(t)) return t(e, 0, [], {});
    if (T(t, "exec")) return t.exec(e, 0, [], {});
...
`,
        type: B.MULTI_MODE_LEXER_WITHOUT_DEFAULT_MODE,
      }),
    T(e, vn) ||
      n.push({
        message:
          ...
          `> property in its definition
`,
        type: B.MULTI_MODE_LEXER_WITHOUT_MODES_PROPERTY,
      }),
    T(e, vn) &&
      T(e, ir) &&
      !T(e.modes, e.defaultMode) &&
      n.push({
        message: `A MultiMode Lexer cannot be initialized with a ${ir}: <${e.defaultMode}>which does not exist
`,
        type: B.MULTI_MODE_LEXER_DEFAULT_MODE_VALUE_DOES_NOT_EXIST,
      }),
    T(e, vn) &&
      x(e.modes, (o, i) => {
        x(o, (a, s) => {
          if (ft(a))
            n.push({
              message: `A Lexer cannot be initialized using an undefined Token Type. Mode:<${i}> at index: <${s}>
`,
              type: B.LEXER_DEFINITION_CANNOT_CONTAIN_UNDEFINED,
            });
          else if (T(a, "LONGER_ALT")) {
            let l = E(a.LONGER_ALT) ? a.LONGER_ALT : [a.LONGER_ALT];
            x(l, (f) => {
              !ft(f) &&
                !D(o, f) &&
                n.push({
                  message: `A MultiMode Lexer cannot be initialized with a longer_alt <${f.name}> on token <${a.name}> outside of mode <${i}>
`,
  ...
  return (
    t &&
      x(a, (l) => {
        let f = Rl(l, s);
        if (f !== !1) {
          let u = { message: oT(l, f), type: f.issue, tokenType: l };
          n.push(u);
        } else
          T(l, "LINE_BREAKS")
            ? l.LINE_BREAKS === !0 && (o = !0)
...
function nT(e) {
  return et(e) && e.length === 1 ? e.charCodeAt(0) : !1;
}
var Il = {
  test: function (e) {
    let t = e.length;
...
function Rl(e, t) {
  if (T(e, "LINE_BREAKS")) return !1;
  if (_t(e.PATTERN)) {
    try {
      Cn(t, e.PATTERN);
    } catch (r) {
      return { issue: B.IDENTIFY_TERMINATOR, errMsg: r.message };
    }
    return !1;
  } else {
    if (et(e.PATTERN)) return !1;
    if (Al(e)) return { issue: B.CUSTOM_LINE_BREAK };
    throw Error("non exhaustive match");
  }
}
function oT(e, t) {
  if (t.issue === B.IDENTIFY_TERMINATOR)
    return `Warning: unable to identify line terminator usage in pattern.
	The problem is in the <${e.name}> Token Type
	 Root cause: ${t.errMsg}.
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#IDENTIFY_TERMINATOR`;
  if (t.issue === B.CUSTOM_LINE_BREAK)
...
function yl(e) {
  return d(e, (r) => (et(r) ? r.charCodeAt(0) : r));
}
function _o(e, t, r) {
...
function iT() {
  if (N(Ln)) {
    Ln = new Array(65536);
    for (let e = 0; e < 65536; e++) Ln[e] = e > 255 ? 255 + ~~(e / 255) : e;
  }
}
function qt(e, t) {
...
function aT(e) {
  let t = b(e),
    ...
    n = !0;
  for (; n; ) {
    r = Bt(j(d(r, (i) => i.CATEGORIES)));
    let o = de(r, t);
    (t = t.concat(o)), N(o) ? (n = !1) : (r = o);
  }
  return t;
}
function sT(e) {
  x(e, (t) => {
    Co(t) || ((_l[Sl] = t), (t.tokenTypeIdx = Sl++)),
      Ol(t) && !E(t.CATEGORIES) && (t.CATEGORIES = [t.CATEGORIES]),
      Ol(t) || (t.CATEGORIES = []),
      cT(t) || (t.categoryMatches = []),
      uT(t) || (t.categoryMatchesMap = {});
  });
}
function lT(e) {
  x(e, (t) => {
    (t.categoryMatches = []),
      x(t.categoryMatchesMap, (r, n) => {
        t.categoryMatches.push(_l[n].tokenTypeIdx);
      });
  });
}
function fT(e) {
...
function cT(e) {
  return T(e, "categoryMatches");
}
function uT(e) {
  return T(e, "categoryMatchesMap");
}
function Cl(e) {
  return T(e, "tokenTypeIdx");
}
var vo = {
  ...
  buildUnexpectedCharactersMessage(e, t, r, n, o) {
    return `unexpected character: ->${e.charAt(
      t
    )}<- at offset: ${t}, skipped ${r} characters.`;
  },
};
var B;
(function (e) {
      ...
      (this.TRACE_INIT = (o, i) => {
        if (this.traceInitPerf === !0) {
          ...
          this.traceInitIndent < this.traceInitMaxIdent &&
            console.log(`${a}--> <${o}>`);
          let { time: s, value: l } = yr(i),
            f = s > 10 ? console.warn : console.log;
          return (
            this.traceInitIndent < this.traceInitMaxIdent &&
              f(`${a}<-- <${o}> time: ${s}ms`),
            this.traceInitIndent--,
...
a boolean 2nd argument is no longer supported`);
    ...
    n === !0
      ...
      this.TRACE_INIT("Lexer Constructor", () => {
        ...
        this.TRACE_INIT("Lexer Config handling", () => {
          if (this.config.lineTerminatorsPattern === Lr.lineTerminatorsPattern)
            this.config.lineTerminatorsPattern = Il;
          else if (
            this.config.lineTerminatorCharacters === Lr.lineTerminatorCharacters
          )
	...
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#MISSING_LINE_TERM_CHARS`);
          ...
          (this.trackStartLines = /full|onlyStart/i.test(
            ...
            E(t)
              ? (o = { modes: { defaultMode: b(t) }, defaultMode: ir })
              : ((i = !1), (o = b(t)));
        }),
          ...
          (o.modes = o.modes ? o.modes : {}),
          x(o.modes, (s, l) => {
            o.modes[l] = me(s, (f) => ft(f));
          });
        let a = k(o.modes);
        if (
          (x(o.modes, (s, l) => {
              ...
              if (
                ...
                this.config.skipValidations === !1 &&
                  this.TRACE_INIT("validatePatterns", () => {
                    this.lexerDefinitionErrors =
                      this.lexerDefinitionErrors.concat(xl(s, a));
                  }),
                N(this.lexerDefinitionErrors))
              ) {
                Zt(s);
                let f;
                this.TRACE_INIT("analyzeTokenTypes", () => {
                  ...
                  (this.patternIdxToConfig[l] = f.patternIdxToConfig),
                  (this.charCodeToPatternIdxToConfig[l] =
                    f.charCodeToPatternIdxToConfig),
                  (this.emptyGroups = tt({}, this.emptyGroups, f.emptyGroups)),
                  (this.hasCustom = f.hasCustom || this.hasCustom),
                  (this.canModeBeOptimized[l] = f.canBeOptimized);
              }
            });
          }),
          (this.defaultMode = o.defaultMode),
          !N(this.lexerDefinitionErrors) &&
            !this.config.deferDefinitionErrorsHandling)
        ) {
          let l = d(this.lexerDefinitionErrors, (f) => f.message)
            .join(`-----------------------
`);
          throw new Error(
...
` + l
        ...
        x(this.lexerDefinitionWarning, (s) => {
          Rr(s.message);
        }),
          this.TRACE_INIT("Choosing sub-methods implementations", () => {
            if (
              (No
                ? ((this.chopInput = St), (this.match = this.matchWithTest))
                : ((this.updateLastIndex = K),
                  (this.match = this.matchWithExec)),
              i && (this.handleModes = K),
              this.trackStartLines === !1 && (this.computeNewColumn = St),
          ...
          this.TRACE_INIT("Failed Optimization Warnings", () => {
            let s = $(
              this.canModeBeOptimized,
              (l, f, c) => (f === !1 && l.push(c), l),
              []
            );
            if (r.ensureOptimizations && !N(s))
  ...
  tokenize(t, r = this.defaultMode) {
    if (!N(this.lexerDefinitionErrors)) {
      let o = d(this.lexerDefinitionErrors, (i) => i.message)
        .join(`-----------------------
`);
      throw new Error(
...
` + o
  ...
  tokenizeInternal(t, r) {
    let n,
      ...
      _ = 0,
      At = 0,
      io = this.hasCustom ? 0 : Math.floor(t.length / 10),
      bt = new Array(io),
      ao = [],
      dr = this.trackStartLines ? 1 : void 0,
      Jt = this.trackStartLines ? 1 : void 0,
      mr = El(this.emptyGroups),
      yf = this.trackStartLines,
      so = this.config.lineTerminatorsPattern,
      Wr = 0,
      Qt = [],
      xr = [],
      Kr = [],
    ...
    function ri(at) {
      let yt = Kt(at),
        Le = xr[yt];
      return Le === void 0 ? ti : Le;
    }
    let Sf = (at) => {
      if (Kr.length === 1 && at.tokenType.PUSH_MODE === void 0) {
        let yt =
          this.config.errorMessageProvider.buildUnableToPopLexerModeMessage(at);
        ao.push({
          offset: at.startOffset,
          line: at.startLine,
          column: at.startColumn,
          length: at.image.length,
          message: yt,
        });
      } else {
        Kr.pop();
        let yt = Gt(Kr);
        (Qt = this.patternIdxToConfig[yt]),
          (xr = this.charCodeToPatternIdxToConfig[yt]),
          (Wr = Qt.length);
        let Le = this.canModeBeOptimized[yt] && this.config.safeMode === !1;
        xr && Le ? (gr = ri) : (gr = ei);
      }
    };
    function ni(at) {
      Kr.push(at),
        (xr = this.charCodeToPatternIdxToConfig[at]),
        (Qt = this.patternIdxToConfig[at]),
        (Wr = Qt.length),
        (Wr = Qt.length);
      let yt = this.canModeBeOptimized[at] && this.config.safeMode === !1;
      xr && yt ? (gr = ri) : (gr = ei);
    }
    ni.call(this, r);
    let Nt,
      oi = this.config.recoveryEnabled;
    for (; _ < O; ) {
      l = null;
      let at = h.charCodeAt(_),
        yt = gr(at),
        Le = yt.length;
      for (n = 0; n < Le; n++) {
        Nt = yt[n];
        ...
        if (
          (jt !== !1
            ...
            ? ((m = It.exec(h, _, bt, mr)),
              m !== null
                ? ((l = m[0]), m.payload !== void 0 && (f = m.payload))
                : (l = null))
            : (this.updateLastIndex(It, _), (l = this.match(It, t, _))),
          l !== null)
        ) {
          if (((s = Nt.longerAlt), s !== void 0)) {
            let te = s.length;
            for (i = 0; i < te; i++) {
              let $t = Qt[s[i]],
                Ee = $t.pattern;
              if (
                ...
                $t.isCustom === !0
                  ? ((m = Ee.exec(h, _, bt, mr)),
                    m !== null
                      ? ((a = m[0]), m.payload !== void 0 && (c = m.payload))
                      : (a = null))
                  : (this.updateLastIndex(Ee, _), (a = this.match(Ee, t, _))),
                a && a.length > l.length)
              ) {
                (l = a), (f = c), (Nt = $t);
                break;
      ...
      if (l !== null) {
        if (
          ...
          p !== void 0 &&
            ((g = Nt.tokenTypeIdx),
            (I = this.createTokenInstance(l, _, g, Nt.tokenType, dr, Jt, u)),
            this.handlePayload(I, f),
            p === !1 ? (At = this.addToken(bt, At, I)) : mr[p].push(I)),
          (t = this.chopInput(t, u)),
          (_ = _ + u),
          (Jt = this.computeNewColumn(Jt, u)),
          yf === !0 && Nt.canLineTerminator === !0)
        ) {
          let It = 0,
            jt,
            te;
          so.lastIndex = 0;
          do (jt = so.test(l)), jt === !0 && ((te = so.lastIndex - 1), It++);
          while (jt === !0);
          It !== 0 &&
            ((dr = dr + It),
            (Jt = u - te),
            this.updateTokenEndLineColumnLocation(I, p, te, It, dr, Jt, u));
        }
        this.handleModes(Nt, Sf, ni, I);
      } else {
        let It = _,
          jt = dr,
          te = Jt,
          $t = oi === !1;
        for (; $t === !1 && _ < O; )
          for (t = this.chopInput(t, 1), _++, o = 0; o < Wr; o++) {
            let Ee = Qt[o],
              lo = Ee.pattern,
              ii = Ee.short;
            if (
              (ii !== !1
                ? h.charCodeAt(_) === ii && ($t = !0)
                : Ee.isCustom === !0
                ? ($t = lo.exec(h, _, bt, mr) !== null)
                : (this.updateLastIndex(lo, _), ($t = lo.exec(t) !== null)),
              $t === !0)
            )
              break;
          }
        if (
          ...
          ao.push({ offset: It, line: jt, column: te, length: R, message: A }),
          oi === !1)
        )
          break;
      }
    ...
    return (
      this.hasCustom || (bt.length = At), { tokens: bt, groups: mr, errors: ao }
    );
  }
  handleModes(t, r, n, o) {
    if (t.pop === !0) {
      let i = t.push;
      r(o), i !== void 0 && n.call(this, i);
  ...
  updateTokenEndLineColumnLocation(t, r, n, o, i, a, s) {
    let l, f;
    r !== void 0 &&
      ((l = n === s - 1),
      (f = l ? -1 : 0),
      (o === 1 && l === !0) ||
        ((t.endLine = i + f), (t.endColumn = a - 1 + -f)));
  }
  computeNewColumn(t, r) {
    return t + r;
  }
  createOffsetOnlyToken(t, r, n, o) {
    return { image: t, startOffset: r, tokenTypeIdx: n, tokenType: o };
  }
  createStartOnlyToken(t, r, n, o, i, a) {
    return {
      image: t,
      startOffset: r,
      startLine: i,
...
function dT(e) {
  let t = e.pattern,
    r = {};
  if (((r.name = e.name), ft(t) || (r.PATTERN = t), T(e, hT)))
    throw `The parent property is no longer supported.
See: https://github.com/chevrotain/chevrotain/issues/564#issuecomment-349062346 for details.`;
  return (
    T(e, vl) && (r.CATEGORIES = e[vl]),
    Zt([r]),
    T(e, Ll) && (r.LABEL = e[Ll]),
    T(e, bl) && (r.GROUP = e[bl]),
    T(e, kl) && (r.POP_MODE = e[kl]),
    T(e, Pl) && (r.PUSH_MODE = e[Pl]),
    T(e, Ml) && (r.LONGER_ALT = e[Ml]),
    T(e, wl) && (r.LINE_BREAKS = e[wl]),
    T(e, Fl) && (r.START_CHARS_HINT = e[Fl]),
    r
  );
}
var vt = bn({ name: "EOF", pattern: it.NA });
Zt([vt]);
...
var Pn = {
  buildMismatchTokenMessage({
    ...
    return `Expecting ${
      Lo(e) ? `--> ${Ne(e)} <--` : `token of type --> ${e.name} <--`
    } but found --> '${t.image}' <--`;
  },
...
but found: '` +
    ...
    if (n) return i + n + s;
    {
      let l = $(e, (p, g) => p.concat(g), []),
        f = d(l, (p) => `[${d(p, (g) => Ne(g)).join(", ")}]`),
        u = `one of these possible Token sequences:
${d(f, (p, g) => `  ${g + 1}. ${p}`).join(`
`)}`;
      return i + u + s;
    }
...
and Non-Terminal names start with a lower case letter.`;
    ...
    buildAlternationPrefixAmbiguityError(e) {
      let t = d(e.prefixPath, (o) => Ne(o)).join(", "),
        r = e.alternation.idx === 0 ? "" : e.alternation.idx;
      return `Ambiguous alternatives: <${e.ambiguityIndices.join(
        " ,"
...
For Further details.`;
    ...
    buildAlternationAmbiguityError(e) {
      let t = d(e.prefixPath, (o) => Ne(o)).join(", "),
        r = e.alternation.idx === 0 ? "" : e.alternation.idx,
        n = `Ambiguous Alternatives Detected: <${e.ambiguityIndices.join(
          " ,"
        )}> in <OR${r}> inside <${e.topLevelRule.name}> Rule,
<${t}> may appears as a prefix path in all these alternatives.
`;
...
This could lead to an infinite loop.`
    ...
    buildEmptyAlternationError(e) {
      return `Ambiguous empty alternative: <${e.emptyChoiceIdx + 1}> in <OR${
        e.alternation.idx
 ...
 has ${e.alternation.definition.length + 1} alternatives.`;
    ...
    buildLeftRecursionError(e) {
      let t = e.topLevelRule.name,
        r = d(e.leftRecursionPath, (i) => i.name),
        n = `${t} --> ${r.concat([t]).join(" --> ")}`;
...
var Po = class extends ct {
  ...
  visitNonTerminal(t) {
    ...
    if (r) t.referencedRule = r;
      ...
      this.errors.push({
        message: n,
        type: rt.UNRESOLVED_SUBRULE_REF,
...
var ko = class extends Yt {
    ...
    startWalking() {
      ...
      return (
        (this.ruleStack = b(this.path.ruleStack).reverse()),
        (this.occurrenceStack = b(this.path.occurrenceStack).reverse()),
        this.ruleStack.pop(),
    ...
    walkProdRef(t, r, n) {
      if (
        ...
        let o = r.concat(n);
        this.updateExpectedNext(), this.walk(t.referencedRule, o);
      }
    }
    updateExpectedNext() {
      N(this.ruleStack)
  ...
  kn = class extends ko {
    ...
    walkTerminal(t, r, n) {
      if (
        ...
        let o = r.concat(n),
          i = new w({ definition: o });
        (this.possibleTokTypes = Se(i)), (this.found = !0);
      }
    }
  },
  sr = class extends Yt {
  ...
  Mn = class extends sr {
    walkMany(t, r, n) {
      if (t.idx === this.occurrence) {
        let o = ot(r.concat(n));
        (this.result.isEndOfRule = o === void 0),
          o instanceof C &&
            ((this.result.token = o.terminalType),
            (this.result.occurrence = o.idx));
...
function Fn(e, t, r = []) {
  ...
  let n = [],
    o = 0;
  function i(s) {
    return s.concat(X(e, o + 1));
  }
  function a(s) {
    let l = Fn(i(s), t, r);
    return n.concat(l);
  }
  for (; r.length < t && o < e.length; ) {
    let s = e[o];
    if (s instanceof w) return a(s.definition);
    if (s instanceof P) return a(s.definition);
    if (s instanceof U) n = a(s.definition);
    else if (s instanceof Y) {
      let l = s.definition.concat([new L({ definition: s.definition })]);
      return a(l);
    } else if (s instanceof q) {
      let l = [
        new w({ definition: s.definition }),
        new L({
          definition: [new C({ terminalType: s.separator })].concat(
            s.definition
          ),
        }),
      ];
      ...
      if (s instanceof z)
        return (
          x(s.definition, (l) => {
            N(l.definition) === !1 && (n = a(l.definition));
          }),
          n
        );
      if (s instanceof C) r.push(s.terminalType);
      else throw Error("non exhaustive match");
    }
    o++;
  }
  return n.push({ partialPath: r, suffixDef: X(e, o) }), n;
}
function Un(e, t, r, n) {
  let o = "EXIT_NONE_TERMINAL",
    i = [o],
    a = "EXIT_ALTERNATIVE",
    s = !1,
    l = t.length,
    ...
    u = [];
  for (
    u.push({ idx: -1, def: e, ruleStack: [], occurrenceStack: [] });
    !N(u);
    ...
    let A = g[0];
    if (A === o) {
      let m = { idx: I, def: X(g), ruleStack: Xt(R), occurrenceStack: Xt(S) };
      u.push(m);
    } else if (A instanceof C)
      if (I < l - 1) {
        let m = I + 1,
          h = t[m];
        if (r(h, A.terminalType)) {
          let O = { idx: m, def: X(g), ruleStack: R, occurrenceStack: S };
          u.push(O);
        }
      } else if (I === l - 1)
        c.push({
      ...
      let m = b(R);
      m.push(A.nonTerminalName);
      let h = b(S);
      h.push(A.idx);
      let O = {
        idx: I,
        def: A.definition.concat(i, X(g)),
        ruleStack: m,
        occurrenceStack: h,
      };
      u.push(O);
    } else if (A instanceof U) {
      let m = { idx: I, def: X(g), ruleStack: R, occurrenceStack: S };
      u.push(m), u.push(a);
      let h = {
        idx: I,
        def: A.definition.concat(X(g)),
        ruleStack: R,
        occurrenceStack: S,
      };
      u.push(h);
    } else if (A instanceof Y) {
      let m = new L({ definition: A.definition, idx: A.idx }),
        h = A.definition.concat([m], X(g)),
        O = { idx: I, def: h, ruleStack: R, occurrenceStack: S };
      u.push(O);
    } else if (A instanceof q) {
      let m = new C({ terminalType: A.separator }),
        h = new L({ definition: [m].concat(A.definition), idx: A.idx }),
        O = A.definition.concat([h], X(g)),
        _ = { idx: I, def: O, ruleStack: R, occurrenceStack: S };
      u.push(_);
    } else if (A instanceof H) {
      let m = { idx: I, def: X(g), ruleStack: R, occurrenceStack: S };
      u.push(m), u.push(a);
      let h = new C({ terminalType: A.separator }),
        O = new L({ definition: [h].concat(A.definition), idx: A.idx }),
        _ = A.definition.concat([O], X(g)),
        At = { idx: I, def: _, ruleStack: R, occurrenceStack: S };
      u.push(At);
    } else if (A instanceof L) {
      let m = { idx: I, def: X(g), ruleStack: R, occurrenceStack: S };
      u.push(m), u.push(a);
      let h = new L({ definition: A.definition, idx: A.idx }),
        O = A.definition.concat([h], X(g)),
        _ = { idx: I, def: O, ruleStack: R, occurrenceStack: S };
      u.push(_);
    } else if (A instanceof z)
      for (let m = A.definition.length - 1; m >= 0; m--) {
        let h = A.definition[m],
          O = {
            idx: I,
            def: h.definition.concat(X(g)),
            ruleStack: R,
            occurrenceStack: S,
          };
        u.push(O), u.push(a);
    ...
    else if (A instanceof mt) u.push(mT(A, I, R, S));
    else throw Error("non exhaustive match");
  }
  return c;
}
function mT(e, t, r, n) {
  ...
  let i = b(n);
  return (
    i.push(1), { idx: t, def: e.definition, ruleStack: o, occurrenceStack: i }
  );
}
var G;
(function (e) {
...
function kr(e) {
  if (e instanceof U || e === "Option") return G.OPTION;
  if (e instanceof L || e === "Repetition") return G.REPETITION;
  if (e instanceof Y || e === "RepetitionMandatory")
    return G.REPETITION_MANDATORY;
  if (e instanceof q || e === "RepetitionMandatoryWithSeparator")
  ...
  if (e instanceof z || e === "Alternation") return G.ALTERNATION;
  throw Error("non exhaustive match");
}
function xT(e) {
  let { occurrence: t, rule: r, prodType: n, maxLookahead: o } = e,
    i = kr(n);
  return i === G.ALTERNATION ? lr(t, r, o) : fr(t, r, i, o);
}
  ...
  if (i && !n) {
    let a = d(e, (l) => j(l)),
      s = $(
        ...
        (l, f, c) => (
          x(f, (u) => {
            T(l, u.tokenTypeIdx) || (l[u.tokenTypeIdx] = c),
              x(u.categoryMatches, (p) => {
                T(l, p) || (l[p] = c);
              });
          }),
          l
...
function jl(e, t, r) {
  let n = st(e, (i) => i.length === 1),
    o = e.length;
  if (n && !r) {
    let i = j(e);
    if (i.length === 1 && N(i[0].categoryMatches)) {
      let s = i[0].tokenTypeIdx;
      return function () {
...
var wo = class extends Yt {
    ...
    checkIsTarget(t, r, n, o) {
      return t.idx === this.targetOccurrence && this.targetProdType === r
        ? ((this.restDef = n.concat(o)), !0)
        : !1;
    }
    walkOption(t, r, n) {
      this.checkIsTarget(t, G.OPTION, r, n) || super.walkOption(t, r, n);
    }
    walkAtLeastOne(t, r, n) {
      this.checkIsTarget(t, G.REPETITION_MANDATORY, r, n) ||
        super.walkOption(t, r, n);
    }
    walkAtLeastOneSep(t, r, n) {
      this.checkIsTarget(t, G.REPETITION_MANDATORY_WITH_SEPARATOR, r, n) ||
        super.walkOption(t, r, n);
    }
    walkMany(t, r, n) {
      this.checkIsTarget(t, G.REPETITION, r, n) || super.walkOption(t, r, n);
    }
    walkManySep(t, r, n) {
      this.checkIsTarget(t, G.REPETITION_WITH_SEPARATOR, r, n) ||
        super.walkOption(t, r, n);
    }
  },
  Dn = class extends ct {
    ...
    visitOption(t) {
      this.checkIsTarget(t, G.OPTION);
    }
    visitRepetition(t) {
      this.checkIsTarget(t, G.REPETITION);
    }
    visitRepetitionMandatory(t) {
      this.checkIsTarget(t, G.REPETITION_MANDATORY);
    }
    visitRepetitionMandatoryWithSeparator(t) {
      this.checkIsTarget(t, G.REPETITION_MANDATORY_WITH_SEPARATOR);
    }
    visitRepetitionWithSeparator(t) {
      this.checkIsTarget(t, G.REPETITION_WITH_SEPARATOR);
    }
    visitAlternation(t) {
      this.checkIsTarget(t, G.ALTERNATION);
    }
  };
function Bl(e) {
  let t = new Array(e);
  ...
  for (let a = 1; a <= t; a++) {
    ...
    for (let l = 0; l < s.length; l++) {
      ...
      for (let c = 0; c < f.length; c++) {
        let u = f[c].partialPath,
          p = f[c].suffixDef,
          g = Mo(u);
        if (gT(o, g, l) || N(p) || u.length === t) {
          let R = n[l];
          if (Bn(R, u) === !1) {
            R.push(u);
...
function lr(e, t, r, n) {
  let o = new Dn(e, G.ALTERNATION, n);
  return t.accept(o), $l(o.result, r);
}
function fr(e, t, r, n) {
  let o = new Dn(e, r);
  t.accept(o);
  let i = o.result,
    s = new wo(t, e, r).startWalking(),
    l = new w({ definition: i }),
    f = new w({ definition: s });
  return $l([l, f], n);
}
function Bn(e, t) {
...
function Hl(e, t) {
  return (
    ...
    st(e, (r, n) => {
      let o = t[n];
      return r === o || o.categoryMatchesMap[r.tokenTypeIdx];
    })
  );
}
function zl(e) {
  return st(e, (t) => st(t, (r) => st(r, (n) => N(n.categoryMatches))));
}
function Vl(e) {
  ...
  return d(t, (r) =>
    Object.assign({ type: rt.CUSTOM_LOOKAHEAD_VALIDATION }, r)
  );
}
function Xl(e, t, r, n) {
  let o = dt(e, (l) => TT(l, r)),
...
function TT(e, t) {
  ...
  return d(v(i), (s) => {
    let l = ot(s),
      f = t.buildDuplicateFoundError(e, s),
      c = Et(l),
      u = {
        message: f,
        type: rt.DUPLICATE_PRODUCTIONS,
        ruleName: e.name,
        dslName: c,
        occurrence: l.idx,
      },
...
function ET(e) {
  return `${Et(e)}_#_${e.idx}_#_${Yl(e)}`;
}
function Yl(e) {
...
function AT(e, t, r, n) {
  let o = [];
  if ($(t, (a, s) => (s.name === e.name ? a + 1 : a), 0) > 1) {
    let a = n.buildDuplicateRuleNameError({ topLevelRule: e, grammarName: r });
    o.push({ message: a, type: rt.DUPLICATE_RULE_NAME, ruleName: e.name });
  }
  return o;
}
function ql(e, t, r) {
  ...
  return (
    D(t, e) ||
      ((o = `Invalid rule override, rule: ->${e}<- cannot be overridden in the grammar: ->${r}<-as it is not defined in any of the super grammars `),
      n.push({ message: o, type: rt.INVALID_RULE_OVERRIDE, ruleName: e })),
    n
  );
}
function Do(e, t, r, n = []) {
  ...
  if (N(i)) return [];
  {
    ...
    D(i, e) &&
      o.push({
        ...
        type: rt.LEFT_RECURSION,
        ruleName: a,
      });
    let l = de(i, n.concat([e])),
      f = dt(l, (c) => {
        let u = b(n);
        return u.push(c), Do(e, c, r, u);
      });
    return o.concat(f);
  }
}
function Gn(e) {
  ...
  if (N(e)) return t;
  let r = ot(e);
  if (r instanceof P) t.push(r.referencedRule);
  else if (
    r instanceof w ||
    r instanceof U ||
    r instanceof Y ||
    ...
    t = t.concat(Gn(r.definition));
  else if (r instanceof z) t = j(d(r.definition, (i) => Gn(i.definition)));
  else if (!(r instanceof C)) throw Error("non exhaustive match");
  let n = ye(r),
    o = e.length > 1;
  if (n && o) {
    let i = X(e);
    return t.concat(Gn(i));
  } else return t;
}
...
function Jl(e, t, r) {
  let n = new Mr();
  e.accept(n);
  let o = n.alternations;
  return (
    (o = me(o, (a) => a.ignoreAmbiguities === !0)),
    dt(o, (a) => {
      let s = a.idx,
        l = a.maxLookahead || t,
        f = lr(s, e, l, a),
    ...
    x(e, (o) => {
      ...
      x(a, (s) => {
        let l = kr(s),
          ...
          p = fr(c, o, l, f)[0];
        if (N(j(p))) {
          let g = r.buildEmptyRepetitionError({
            topLevelRule: o,
            repetition: s,
          });
          n.push({
            message: g,
            type: rt.NO_NON_EMPTY_LOOKAHEAD,
            ruleName: o.name,
          });
        }
      });
...
function RT(e, t, r, n) {
  let o = [],
    i = $(
      e,
      (s, l, f) => (
        t.definition[f].ignoreAmbiguities === !0 ||
          x(l, (c) => {
            let u = [f];
            x(e, (p, g) => {
              f !== g &&
                Bn(p, c) &&
                t.definition[g].ignoreAmbiguities !== !0 &&
                u.push(g);
            }),
              u.length > 1 &&
                !Bn(o, c) &&
                (o.push(c), s.push({ alts: u, path: c }));
          }),
        s
      ),
      []
...
function yT(e, t, r, n) {
  ...
  return Bt(
    dt(o, (a) => {
      if (t.definition[a.idx].ignoreAmbiguities === !0) return [];
      let l = a.idx,
        f = a.path,
        c = lt(
          o,
...
function ST(e, t, r) {
  ...
  return (
    x(e, (i) => {
      let a = i.name;
      if (D(o, a)) {
        let s = r.buildNamespaceConflictError(i);
        n.push({
          message: s,
          type: rt.CONFLICT_TOKENS_RULES_NAMESPACE,
          ruleName: a,
        });
      }
    }),
...
function tf(e) {
  let t = Qe(e, { errMsgProvider: Ul }),
    r = {};
  return (
    x(e.rules, (n) => {
      r[n.name] = n;
    }),
    Dl(r, t.errMsgProvider)
  );
}
function ef(e) {
  return (
    (e = Qe(e, { errMsgProvider: Lt })),
    Xl(e.rules, e.tokenTypes, e.errMsgProvider, e.grammarName)
  );
}
var rf = "MismatchedTokenException",
  nf = "NoViableAltException",
...
var cr = class extends Error {
  ...
  ve = class extends cr {
    constructor(t, r, n) {
      super(t, r), (this.previousToken = n), (this.name = rf);
    }
  },
  wr = class extends cr {
    constructor(t, r, n) {
      super(t, r), (this.previousToken = n), (this.name = nf);
    }
  },
  Fr = class extends cr {
    constructor(t, r) {
      super(t, r), (this.name = af);
    }
  },
  Ur = class extends cr {
    constructor(t, r, n) {
      super(t, r), (this.previousToken = n), (this.name = of);
    }
  };
var Bo = {},
  Wo = "InRuleRecoveryException",
  Go = class extends Error {
    constructor(t) {
      super(t), (this.name = Wo);
    }
  },
  Wn = class {
    initRecoverable(t) {
      (this.firstAfterRepMap = {}),
        (this.resyncFollows = {}),
        (this.recoveryEnabled = T(t, "recoveryEnabled")
          ? t.recoveryEnabled
          : ut.recoveryEnabled),
        this.recoveryEnabled && (this.attemptInRepetitionRecovery = OT);
    }
    getTokenToInsert(t) {
      let r = Ce(t, "", NaN, NaN, NaN, NaN, NaN, NaN);
    ...
    tryInRepetitionRecovery(t, r, n, o) {
      let i = this.findReSyncTokenType(),
        ...
        u = () => {
          let p = this.LA(0),
            g = this.errorMessageProvider.buildMismatchTokenMessage({
              expected: o,
              actual: f,
              previous: p,
              ruleName: this.getCurrRuleFullName(),
            }),
            I = new ve(g, f, this.LA(0));
          (I.resyncedTokens = Xt(s)), this.SAVE_ERROR(I);
        };
      for (; !l; )
        if (this.tokenMatcher(c, o)) {
          u();
          return;
        } else if (n.call(this)) {
          u(), t.apply(this, r);
          ...
          this.tokenMatcher(c, i)
            ? (l = !0)
            : ((c = this.SKIP_TOKEN()), this.addToResyncTokens(c, s));
    ...
    canRecoverWithSingleTokenInsertion(t, r) {
      if (!this.canTokenTypeBeInsertedInRecovery(t) || N(r)) return !1;
      let n = this.LA(1);
      return Wt(r, (i) => this.tokenMatcher(n, i)) !== void 0;
    }
    ...
    getCurrFollowKey() {
      if (this.RULE_STACK.length === 1) return Bo;
      ...
      return d(t, (n, o) =>
        o === 0
          ...
          : {
              ...
              inRule: this.shortRuleNameToFullName(t[o - 1]),
            }
      );
    }
    flattenFollowSet() {
      let t = d(this.buildFullFollowKeyStack(), (r) =>
    ...
    getFollowSetFromFollowKey(t) {
      if (t === Bo) return [vt];
      let r = t.ruleName + t.idxInCallingRule + yn + t.inRule;
      return this.resyncFollows[r];
    }
    addToResyncTokens(t, r) {
      return this.tokenMatcher(t, vt) || r.push(t), r;
    }
    reSyncTo(t) {
      let r = [],
        n = this.LA(1);
    ...
    attemptInRepetitionRecovery(t, r, n, o, i, a, s) {}
    getCurrentGrammarPath(t, r) {
      let n = this.getHumanReadableRuleStack(),
        o = b(this.RULE_OCCURRENCE_STACK);
      return {
        ruleStack: n,
        occurrenceStack: o,
        lastTok: t,
    ...
    getHumanReadableRuleStack() {
      return d(this.RULE_STACK, (t) => this.shortRuleNameToFullName(t));
    }
  };
function OT(e, t, r, n, o, i, a) {
  let s = this.getKeyForAutomaticLookahead(n, o),
    l = this.firstAfterRepMap[s];
  if (l === void 0) {
    let p = this.getCurrRuleFullName(),
      g = this.getGAstProductions()[p];
    (l = new i(g, o).startWalking()), (this.firstAfterRepMap[s] = l);
  }
  let f = l.token,
    c = l.occurrence,
    u = l.isEndOfRule;
  this.RULE_STACK.length === 1 && u && f === void 0 && ((f = vt), (c = 1)),
    !(f === void 0 || c === void 0) &&
      this.shouldInRepetitionRecoveryBeTried(f, c, a) &&
      this.tryInRepetitionRecovery(e, t, r, f);
}
function Kn(e, t, r) {
  return r | t | e;
}
...
var Dr = class {
  constructor(t) {
    var r;
    this.maxLookahead =
      (r = t?.maxLookahead) !== null && r !== void 0 ? r : ut.maxLookahead;
  }
  validate(t) {
    let r = this.validateNoLeftRecursion(t.rules);
    if (N(r)) {
      let n = this.validateEmptyOrAlternatives(t.rules),
        o = this.validateAmbiguousAlternationAlternatives(
          t.rules,
          this.maxLookahead
        ),
...
var $n = class {
    initLooksAhead(t) {
      (this.dynamicTokensEnabled = T(t, "dynamicTokensEnabled")
        ? t.dynamicTokensEnabled
        : ut.dynamicTokensEnabled),
        (this.maxLookahead = T(t, "maxLookahead")
          ? t.maxLookahead
          : ut.maxLookahead),
        (this.lookaheadStrategy = T(t, "lookaheadStrategy")
          ? t.lookaheadStrategy
          : new Dr({ maxLookahead: this.maxLookahead })),
    ...
    preComputeLookaheadFunctions(t) {
      x(t, (r) => {
        this.TRACE_INIT(`${r.name} Rule Lookahead`, () => {
          ...
          x(n, (f) => {
            let c = f.idx === 0 ? "" : f.idx;
            this.TRACE_INIT(`${Et(f)}${c}`, () => {
              let u = this.lookaheadStrategy.buildLookaheadForAlternation({
                  prodOccurrence: f.idx,
                  rule: r,
                  maxLookahead: f.maxLookahead || this.maxLookahead,
                  hasPredicates: f.hasPredicates,
                  dynamicTokensEnabled: this.dynamicTokensEnabled,
                }),
                p = Kn(this.fullRuleNameToShort[r.name], 256, f.idx);
    ...
    computeLookaheadFunc(t, r, n, o, i, a) {
      this.TRACE_INIT(`${a}${r === 0 ? "" : r}`, () => {
        let s = this.lookaheadStrategy.buildLookaheadForOptional({
          ...
          l = Kn(this.fullRuleNameToShort[t.name], n, r);
...
function cf(e, t) {
  let r = function () {};
  Vo(r, e + "BaseSemantics");
  let n = {
    visit: function (o, i) {
      if ((E(o) && (o = o[0]), !ft(o))) return this[o.name](o.children, i);
    },
...
`
  ...
  return (
    (r.prototype = n), (r.prototype.constructor = r), (r._RULE_NAMES = t), r
  );
}
function uf(e, t, r) {
  let n = function () {};
  Vo(n, e + "BaseSemanticsWithDefaults");
  let o = Object.create(r.prototype);
  return (
    x(t, (i) => {
      o[i] = CT;
    }),
...
function LT(e, t) {
  let r = lt(t, (o) => ht(e[o]) === !1),
    n = d(r, (o) => ({
      msg: `Missing visitor method: <${o}> on ${e.constructor.name} CST Visitor.`,
...
var Xn = class {
  initTreeBuilder(t) {
    if (
      ...
      (this.nodeLocationTracking = T(t, "nodeLocationTracking")
        ? t.nodeLocationTracking
        : ut.nodeLocationTracking),
      !this.outputCst)
    )
      ...
      this.recoveryEnabled
        ? ((this.setNodeLocationFromToken = zo),
          (this.setNodeLocationFromNode = zo),
          (this.cstPostRule = K),
  ...
  cstPostTerminal(t, r) {
    ...
    lf(n, r, t), this.setNodeLocationFromToken(n.location, r);
  }
  cstPostNonTerminal(t, r) {
    let n = this.CST_STACK[this.CST_STACK.length - 1];
    ff(n, r, t), this.setNodeLocationFromNode(n.location, t.location);
  }
  getBaseCstVisitorConstructor() {
    if (ft(this.baseCstVisitorConstructor)) {
      let t = cf(this.className, k(this.gastProductionsCache));
      return (this.baseCstVisitorConstructor = t), t;
    }
    return this.baseCstVisitorConstructor;
  }
  getBaseCstVisitorConstructorWithDefaults() {
    if (ft(this.baseCstVisitorWithDefaultsConstructor)) {
      let t = uf(
        this.className,
        k(this.gastProductionsCache),
...
var Yn = class {
  ...
  LA(t) {
    ...
    return r < 0 || this.tokVectorLength <= r ? ur : this.tokVector[r];
  }
  consumeToken() {
    this.currIdx++;
  }
...
var qn = class {
  ...
  RULE(t, r, n = pr) {
    if (D(this.definedRulesNames, t)) {
      let a = {
        message: Lt.buildDuplicateRuleNameError({
          topLevelRule: t,
          grammarName: this.className,
        }),
        type: rt.DUPLICATE_RULE_NAME,
        ruleName: t,
      };
      this.definitionErrors.push(a);
    }
    this.definedRulesNames.push(t);
    let o = this.defineRule(t, r, n);
    return (this[t] = o), o;
  }
  OVERRIDE_RULE(t, r, n = pr) {
    let o = ql(t, this.definedRulesNames, this.className);
  ...
  getSerializedGastProductions() {
    return Rn(v(this.gastProductionsCache));
  }
};
var Zn = class {
  initRecognizerEngine(t, r) {
    ...
    if (E(t)) this.tokensMap = $(t, (i, a) => ((i[a.name] = a), i), {});
    else if (T(t, "modes") && st(j(v(t.modes)), Cl)) {
      let i = j(v(t.modes)),
        a = xe(i);
      this.tokensMap = $(a, (s, l) => ((s[l.name] = l), s), {});
    } else if (W(t)) this.tokensMap = b(t);
    else
      throw new Error(
    ...
    this.tokensMap.EOF = vt;
    let n = T(t, "modes") ? j(v(t.modes)) : v(t),
      o = st(n, (i) => N(i.categoryMatches));
    (this.tokenMatcher = o ? ar : qt), Zt(v(this.tokensMap));
  }
  defineRule(t, r, n) {
    if (this.selfAnalysisDone)
      throw Error(`Grammar rule <${t}> may not be defined after the 'performSelfAnalysis' method has been called'
Make sure that all grammar rule definitions are done before 'performSelfAnalysis' is called.`);
    let o = T(n, "resyncEnabled") ? n.resyncEnabled : pr.resyncEnabled,
      i = T(n, "recoveryValueFunc")
        ? n.recoveryValueFunc
        : pr.recoveryValueFunc,
      a = this.ruleShortNameIdx << (4 + 8);
    this.ruleShortNameIdx++,
      (this.shortRuleNameToFull[a] = t),
      (this.fullRuleNameToShort[t] = a);
    let s;
    return (
      this.outputCst === !0
        ? (s = function (...c) {
            try {
              this.ruleInvocationStateUpdate(a, t, this.subruleIdx),
                r.apply(this, c);
              let u = this.CST_STACK[this.CST_STACK.length - 1];
              return this.cstPostRule(u), u;
            } catch (u) {
              return this.invokeRuleCatch(u, o, i);
            } finally {
      ...
      Object.assign(s, { ruleName: t, originalGrammarAction: r })
    );
  }
  invokeRuleCatch(t, r, n) {
    let o = this.RULE_STACK.length === 1,
    ...
    if (Te(t)) {
      ...
      if (i) {
        ...
        if (o) return this.moveToTerminatedState(), n(t);
        throw a;
      }
    } else throw t;
  }
  ...
  optionInternalLogic(t, r, n) {
    ...
    if (typeof t != "function") {
      ...
      if (a !== void 0) {
        let s = o;
        o = () => a.call(this) && s.call(this);
      }
    } else i = t;
    if (o.call(this) === !0) return i.call(this);
  }
  ...
  atLeastOneInternalLogic(t, r, n) {
    ...
    if (o.call(this) === !0) {
      ...
      for (; o.call(this) === !0 && a === !0; ) a = this.doSingleRepetition(i);
    } else
      throw this.raiseEarlyExitException(t, G.REPETITION_MANDATORY, r.ERR_MSG);
  ...
  atLeastOneSepFirstInternalLogic(t, r, n) {
    ...
    if (this.getLaFuncFromCache(n).call(this) === !0) {
      o.call(this);
      let s = () => this.tokenMatcher(this.LA(1), i);
  ...
  repetitionSepSecondInternal(t, r, n, o, i) {
    for (; n(); ) this.CONSUME(r), o.call(this);
    this.attemptInRepetitionRecovery(
      this.repetitionSepSecondInternal,
      [t, r, n, o, i],
      n,
  ...
  orInternal(t, r) {
    let n = this.getKeyForAutomaticLookahead(256, r),
      o = E(t) ? t : t.DEF,
      a = this.getLaFuncFromCache(n).call(this, o);
    if (a !== void 0) return o[a].ALT.call(this);
  ...
  consumeInternal(t, r, n) {
    ...
    try {
      let i = this.LA(1);
      this.tokenMatcher(i, t) === !0
        ? (this.consumeToken(), (o = i))
        : this.consumeInternalError(t, i, n);
    } catch (i) {
      o = this.consumeInternalRecovery(t, r, i);
    }
    return (
  ...
  consumeInternalError(t, r, n) {
    ...
    throw (
      (n !== void 0 && n.ERR_MSG
        ? (o = n.ERR_MSG)
        : (o = this.errorMessageProvider.buildMismatchTokenMessage({
            expected: t,
            actual: r,
            previous: i,
            ruleName: this.getCurrRuleFullName(),
          })),
      this.SAVE_ERROR(new ve(o, r, i)))
    );
  }
  consumeInternalRecovery(t, r, n) {
    if (
      ...
      let o = this.getFollowsForInRuleRecovery(t, r);
      try {
  ...
  isAtEndOfInput() {
    return this.tokenMatcher(this.LA(1), vt);
  }
  reset() {
...
var Jn = class {
  initErrorHandler(t) {
    (this._errors = []),
      (this.errorMessageProvider = T(t, "errorMessageProvider")
        ? t.errorMessageProvider
        : ut.errorMessageProvider);
  }
  SAVE_ERROR(t) {
    if (Te(t))
      return (
  ...
  raiseEarlyExitException(t, r, n) {
    let o = this.getCurrRuleFullName(),
      i = this.getGAstProductions()[o],
      s = fr(t, i, r, this.maxLookahead)[0],
      l = [];
    for (let c = 1; c <= this.maxLookahead; c++) l.push(this.LA(c));
    let f = this.errorMessageProvider.buildEarlyExitMessage({
    ...
    throw this.SAVE_ERROR(new Ur(f, this.LA(1), this.LA(0)));
  }
  raiseNoAltException(t, r) {
    let n = this.getCurrRuleFullName(),
      o = this.getGAstProductions()[n],
      i = lr(t, o, this.maxLookahead),
      a = [];
    for (let f = 1; f <= this.maxLookahead; f++) a.push(this.LA(f));
    let s = this.LA(0),
    ...
    throw this.SAVE_ERROR(new wr(l, this.LA(1), s));
  }
};
var Qn = class {
  initContentAssist() {}
  computeContentAssist(t, r) {
    ...
    if (ft(n)) throw Error(`Rule ->${t}<- does not exist in this grammar.`);
    return Un([n], r, this.tokenMatcher, this.maxLookahead);
  }
  getNextPossibleTokenTypes(t) {
    let r = ot(t.ruleStack),
      o = this.getGAstProductions()[r];
    return new kn(o, t).startWalking();
  }
};
var ro = {
...
var pf = !0,
  hf = Math.pow(2, 8) - 1,
  mf = bn({ name: "RECORDING_PHASE_TOKEN", pattern: it.NA });
Zt([mf]);
var xf = Ce(
  mf,
...
var PT = {
  ...
  to = class {
    ...
    enableRecording() {
      (this.RECORDING_PHASE = !0),
        this.TRACE_INIT("Enable Recording", () => {
          for (let t = 0; t < 10; t++) {
            let r = t > 0 ? t : "";
            (this[`CONSUME${r}`] = function (n, o) {
              return this.consumeInternalRecord(n, t, o);
            }),
              (this[`SUBRULE${r}`] = function (n, o) {
                return this.subruleInternalRecord(n, t, o);
              }),
    ...
    topLevelRuleRecord(t, r) {
      try {
        let n = new mt({ definition: [], name: t });
        return (
          (n.name = t),
 ...
 inside top level rule: <${this.recordingProdStack[0].name}>`);
      ...
      let o = Gt(this.recordingProdStack),
        i = t.ruleName,
        a = new P({
          idx: r,
          nonTerminalName: i,
      ...
      return o.definition.push(a), this.outputCst ? PT : ro;
    }
    consumeInternalRecord(t, r, n) {
      if ((eo(r), !Co(t))) {
        let a = new Error(`<CONSUME${df(
          r
 ...
 inside top level rule: <${this.recordingProdStack[0].name}>`);
      ...
      let o = Gt(this.recordingProdStack),
        i = new C({ idx: r, terminalType: t, label: n?.LABEL });
      return o.definition.push(i), xf;
    }
  };
function Gr(e, t, r, n = !1) {
  ...
  let o = Gt(this.recordingProdStack),
    i = ht(t) ? t : t.DEF,
    a = new e({ definition: [], idx: r });
  return (
    n && (a.separator = t.SEP),
    T(t, "MAX_LOOKAHEAD") && (a.maxLookahead = t.MAX_LOOKAHEAD),
...
function kT(e, t) {
  eo(t);
  let r = Gt(this.recordingProdStack),
    n = E(e) === !1,
    o = n === !1 ? e : e.DEF,
    i = new z({
      definition: [],
  ...
  T(e, "MAX_LOOKAHEAD") && (i.maxLookahead = e.MAX_LOOKAHEAD);
  let a = Re(o, (s) => ht(s.GATE));
  return (
    (i.hasPredicates = a),
    r.definition.push(i),
    x(o, (s) => {
      let l = new w({ definition: [] });
      i.definition.push(l),
        T(s, "IGNORE_AMBIGUITIES")
          ? (l.ignoreAmbiguities = s.IGNORE_AMBIGUITIES)
          : T(s, "GATE") && (l.ignoreAmbiguities = !0),
...
function eo(e) {
  if (e < 0 || e > hf) {
	...
	Idx value must be a none negative value smaller than ${hf + 1}`);
    throw ((t.KNOWN_RECORDER_ERROR = !0), t);
  }
}
var no = class {
  initPerformanceTracer(t) {
    if (T(t, "traceInitPerf")) {
  ...
  TRACE_INIT(t, r) {
    if (this.traceInitPerf === !0) {
      ...
      this.traceInitIndent < this.traceInitMaxIdent &&
        console.log(`${n}--> <${t}>`);
      let { time: o, value: i } = yr(r),
        a = o > 10 ? console.warn : console.log;
      return (
        this.traceInitIndent < this.traceInitMaxIdent &&
          a(`${n}<-- <${t}> time: ${o}ms`),
        this.traceInitIndent--,
  ...
  t.forEach((r) => {
    ...
    Object.getOwnPropertyNames(n).forEach((o) => {
      ...
      i && (i.get || i.set)
        ...
        : (e.prototype[o] = r.prototype[o]);
    });
  });
}
var ur = Ce(vt, "", NaN, NaN, NaN, NaN, NaN, NaN);
Object.freeze(ur);
var ut = Object.freeze({
    ...
    outputCst: !0,
    errorMessageProvider: Pn,
    nodeLocationTracking: "none",
    traceInitPerf: !1,
    skipValidations: !1,
  }),
  pr = Object.freeze({ recoveryValueFunc: () => {}, resyncEnabled: !0 }),
  rt;
(function (e) {
    ...
    this.TRACE_INIT("performSelfAnalysis", () => {
        ...
        this.TRACE_INIT("Grammar Recording", () => {
          try {
            this.enableRecording(),
              x(this.definedRulesNames, (o) => {
                let a = this[o].originalGrammarAction,
                  s;
                this.TRACE_INIT(`${o} Rule`, () => {
                  s = this.topLevelRuleRecord(o, a);
                }),
                  (this.gastProductionsCache[o] = s);
              });
          } finally {
      ...
      if (
        (this.TRACE_INIT("Grammar Resolving", () => {
          (n = tf({ rules: v(this.gastProductionsCache) })),
            (this.definitionErrors = this.definitionErrors.concat(n));
        }),
        this.TRACE_INIT("Grammar Validations", () => {
          if (N(n) && this.skipValidations === !1) {
            let o = ef({
            ...
            this.definitionErrors = this.definitionErrors.concat(o, i);
          }
        }),
        N(this.definitionErrors) &&
          (this.recoveryEnabled &&
            this.TRACE_INIT("computeAllProdsFollows", () => {
              let o = ll(v(this.gastProductionsCache));
              this.resyncFollows = o;
            }),
          this.TRACE_INIT("ComputeLookaheadFunctions", () => {
            var o, i;
            (i = (o = this.lookaheadStrategy).initialize) === null ||
              i === void 0 ||
              i.call(o, { rules: v(this.gastProductionsCache) }),
              this.preComputeLookaheadFunctions(v(this.gastProductionsCache));
          })),
        !e.DEFER_DEFINITION_ERRORS_HANDLING && !N(this.definitionErrors))
      )
        throw (
          ((t = d(this.definitionErrors, (o) => o.message)),
...
`)}`))
  ...
  constructor(t, r) {
	...
	For further details.`);
    this.skipValidations = T(r, "skipValidations")
      ? r.skipValidations
      : ut.skipValidations;
  }
};
hr.DEFER_DEFINITION_ERRORS_HANDLING = !1;
gf(hr, [Wn, $n, Xn, Yn, Zn, qn, Jn, Qn, to, no]);
var qo = class extends hr {
    constructor(t, r = ut) {
      let n = b(r);
      (n.outputCst = !0), super(t, n);
    }
  },
  Zo = class extends hr {
    constructor(t, r = ut) {
...
function Tf(e) {
  let t = new Jo(),
    r = v(e);
  return d(r, (n) => t.visitRule(n));
}
var Jo = class extends ct {
  visitRule(t) {
    let r = this.visitEach(t.definition),
      n = Ir(r, (i) => i.propertyName),
      o = d(n, (i, a) => {
        let s = !Re(i, (f) => !f.canBeNull),
          l = i[0].type;
        return (
          i.length > 1 && (l = d(i, (f) => f.type)),
          { name: a, type: l, optional: s }
        );
      });
    return { name: t.name, properties: o };
  }
  visitAlternative(t) {
    return this.visitEachAndOverrideWith(t.definition, { canBeNull: !0 });
  }
  visitOption(t) {
    return this.visitEachAndOverrideWith(t.definition, { canBeNull: !0 });
  }
  ...
  visitEachAndOverrideWith(t, r) {
    return d(this.visitEach(t), (n) => tt({}, n, r));
  }
  visitEach(t) {
    return j(d(t, (r) => this.visit(r)));
  }
};
function oo(e) {
  return e instanceof P
    ? { kind: "rule", name: e.referencedRule.name }
    : { kind: "token" };
}
function Af(e, t) {
  let r = [];
  return (
    ...
    (r = r.concat(j(d(e, (n) => wT(n))))),
    t.includeVisitorInterface && (r = r.concat(BT(t.visitorInterfaceName, e))),
    r.join(`
...
function FT(e) {
  let t = If(e.name),
    r = Qo(e.name);
  return `export interface ${t} extends CstNode {
  name: "${e.name}";
  children: ${r};
}`;
}
function UT(e) {
  return `export type ${Qo(e.name)} = {
...
function DT(e) {
  let t = WT(e.type);
  return `${e.name}${e.optional ? "?" : ""}: ${t}[];`;
}
function BT(e, t) {
  return `export interface ${e}<IN, OUT> extends ICstVisitor<IN, OUT> {
  ${d(t, (r) => GT(r)).join(`
  `)}
}`;
}
function GT(e) {
  let t = Qo(e.name);
  return `${e.name}(children: ${t}, param?: IN): OUT;`;
}
function WT(e) {
  if (E(e)) {
    let t = xe(d(e, (n) => Ef(n)));
...
function Ef(e) {
  return e.kind === "token" ? "IToken" : If(e.name);
}
function If(e) {
  return rn(e) + "CstNode";
}
function Qo(e) {
  return rn(e) + "CstChildren";
}
var KT = {
...
function jT(e, t) {
  let r = Object.assign(Object.assign({}, KT), t),
    n = Tf(e);
  return Af(n, r);
}
function $T(
  e,
  {
    resourceBase: t = `https://unpkg.com/chevrotain@${jr}/diagrams/`,
    css: r = `https://unpkg.com/chevrotain@${jr}/diagrams/diagrams.css`,
  } = {}
) {
  let n = `
...
export {
  ...
  MT as EMPTY_ALT,
  vt as EOF,
  Ur as EarlyExitException,
  Zo as EmbeddedActionsParser,
  ct as GAstVisitor,
  Dr as LLkLookaheadStrategy,
  it as Lexer,
  B as LexerDefinitionErrorType,
  ve as MismatchedTokenException,
  wr as NoViableAltException,
  P as NonTerminal,
  Fr as NotAllInputParsedException,
  U as Option,
  Rf as Parser,
  rt as ParserDefinitionErrorType,
  L as Repetition,
  Y as RepetitionMandatory,
  q as RepetitionMandatoryWithSeparator,
  H as RepetitionWithSeparator,
  mt as Rule,
  C as Terminal,
  jr as VERSION,
  jw as clearCache,
  $T as createSyntaxDiagramsCode,
  bn as createToken,
  Ce as createTokenInstance,
  vo as defaultLexerErrorProvider,
  Pn as defaultParserErrorProvider,
  jT as generateCstDts,
  xT as getLookaheadPaths,
  Te as isRecognitionException,
  Rn as serializeGrammar,
  er as serializeProduction,
  Ne as tokenLabel,
  bo as tokenMatcher,
  pT as tokenName,
};
